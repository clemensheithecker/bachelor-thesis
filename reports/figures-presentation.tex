...
\begin{figure}
	\centerline{
		\includegraphics[width=0.8\paperwidth, keepaspectratio]{ {../figures/missing-values-distribution-wide} }
	}
\end{figure}
\end{frame}
...
\begin{figure}
	\centerline{
		\includegraphics[width=0.8\paperwidth, keepaspectratio]{ {../figures/predict-polview-year-pre-2021-model-1} }
	}
\end{figure}
\end{frame}
...
\begin{figure}
	\centerline{
		\includegraphics[width=0.8\paperwidth, keepaspectratio]{ {../figures/predict-polview-year-pre-2021-model-2} }
	}
\end{figure}
\end{frame}
...
\begin{figure}
	\centerline{
		\includegraphics[width=0.8\paperwidth, keepaspectratio]{ {../figures/predict-polview-year-pre-2021-model-3} }
	}
\end{figure}
\end{frame}
...
\begin{figure}
	\centerline{
		\includegraphics[width=0.8\paperwidth, keepaspectratio]{ {../figures/predict-polview-year-incl-2021-model-4} }
	}
\end{figure}
\end{frame}
...
\begin{figure}
	\centerline{
		\includegraphics[width=0.8\paperwidth, keepaspectratio]{ {../figures/predict-polview-year-incl-2021-model-5} }
	}
\end{figure}
\end{frame}
...
\begin{figure}
	\centerline{
		\includegraphics[width=0.8\paperwidth, keepaspectratio]{ {../figures/predict-polview-year-incl-2021-model-6} }
	}
\end{figure}
\end{frame}
